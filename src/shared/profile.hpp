...
const struct Conf_Index profile_index[] = {
	...
	{"camera1:focus_speed",		'f' ,1 ,offsetof(Profile, cam[0].focus_speed)},
	...
	{"camera2:focus_speed",		'f' ,1 ,offsetof(Profile, cam[1].focus_speed)},
	...
	{"camera3:focus_speed",		'f' ,1 ,offsetof(Profile, cam[2].focus_speed)},
	...
	{"camera4:focus_speed",		'f' ,1 ,offsetof(Profile, cam[3].focus_speed)},
