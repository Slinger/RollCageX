...
const struct Conf_Index profile_index[] = {
	...
	{"camera1:tilt_speed",		'f' ,1 ,offsetof(Profile, cam[0].tilt_speed)},
	{"camera1:swing_speed",		'f' ,1 ,offsetof(Profile, cam[0].swing_speed)},
	...
	{"camera2:tilt_speed",		'f' ,1 ,offsetof(Profile, cam[1].tilt_speed)},
	{"camera2:swing_speed",		'f' ,1 ,offsetof(Profile, cam[1].swing_speed)},
	...
	{"camera3:tilt_speed",		'f' ,1 ,offsetof(Profile, cam[2].tilt_speed)},
	{"camera3:swing_speed",		'f' ,1 ,offsetof(Profile, cam[2].swing_speed)},
	...
	{"camera4:tilt_speed",		'f' ,1 ,offsetof(Profile, cam[3].tilt_speed)},
	{"camera4:swing_speed",		'f' ,1 ,offsetof(Profile, cam[3].swing_speed)},
